...
class IndoNLGTokenizerHalim(PreTrainedTokenizer):
        ...
        if model_type == 'indogpt':
            ...
            if type(inputs) == str:
                ...
                if len(inputs) == 0 or type(inputs[0]) != str:
                    raise ValueError(IndoNLGTokenizerHalim.input_error_message)
                else:
    ...
    def pad(self,
        ...
        verbose: bool = True,
        padding_side: Optional[str] = None,  # Add padding_side here
    ) -> BatchEncoding:
        """
